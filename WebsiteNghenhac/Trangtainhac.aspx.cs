...
public partial class Trangtainhac : System.Web.UI.Page
{
    ...
    {
        if(Session["Dadangnhap"].ToString()=="false") Response.Redirect("login.aspx");
        txtMessage.Text = "Banquyencuakhanh" + Session["Tendangnhap"];
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        var fileId = "1gPPfan4U66ONU7r-CpflEous5nUG-pAy";
        ...
        SaveStreamToFile(fullSavePath + "temp.wav",stream);
...

        {
            ...
            try
            {
                ...
                sourceStream = new FileStream(fullSavePath+"temp.wav",FileMode.Open);

                //create an empty file for the carrier wave
                destinationStream = new FileStream(fullSavePath + "temp2.wav", FileMode.Create);
       ...
       string FileName = fullSavePath + "temp2.wav";
